package me.moose.websocket.server.player.impl.rank;
...
public enum Rank {
    ...
    TELLING(11, LunarLogoColors.TELLINQ.getColor(), CC.GOLD.getCode() + "Tellinq", CC.GOLD),
    JEGOX(10, LunarLogoColors.JEGOX.getColor(), CC.BLUE.getCode() + "Jegox", CC.BLUE),
